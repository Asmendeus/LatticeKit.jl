function getAllPairs(latt::General3DLattice{L, W, H, C}, v::NTuple{3, Int64}, which_from::Int64, which_to::Int64, boundary::AbstractBondaryCondition=PBC()) where {L, W, H, C}
