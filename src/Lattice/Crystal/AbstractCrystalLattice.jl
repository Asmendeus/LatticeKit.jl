...
"""
    getAllPairs(latt::AbstractCrystalLattice, v::NTuple{D, Int64}, which_from::Int64, which_to::Int64, boundary::AbstractBoundaryCondition=PBC())

Return the number pairs of all site pairs, whose vector differences are `v`.
"""
function getAllPairs(latt::AbstractCrystalLattice{D}, v::NTuple{D, Int64}, which_from::Int64, which_to::Int64, boundary::AbstractBoundaryCondition=PBC()) where D
    throw(MethodError(getAllPairs, (latt, v, which_from, which_to, boundary)))
end

"""
    getAllPairs(latt::AbstractCrystalLattice, r::Int64, boundary::AbstractBoundaryCondition=PBC())

Return the number pairs of all r-nearest site pairs, e.g., `r = 1` means nearest neighbor.
"""
function getAllPairs(latt::AbstractCrystalLattice, r::Int64, boundary::AbstractBoundaryCondition=PBC())
